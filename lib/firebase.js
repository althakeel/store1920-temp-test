...
function createAuth() {
  ...
  try {
    // IndexedDB first, localStorage fallback — both are shared across tabs.
    // Do not use session/in-memory persistence or a new tab will look logged out.
...
/**
 * Persistence is set once in createAuth(). Do not call setPersistence here —
 * Firebase signs the user out and back in, which logs out other open tabs.
 */
