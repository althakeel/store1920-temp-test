...
export async function createProductFromJson(body, storeId) {
  ...
  const product = await Product.create({
    ...
    seoH1: String(body.seoH1 || '').trim(),
    seoH1Ar: String(body.seoH1Ar || '').trim(),
...
export async function updateProductFromJson(body, storeId, options = {}) {
  ...
  const updateData = {
    ...
    seoH1: body.seoH1 !== undefined ? String(body.seoH1 || '').trim() : undefined,
    seoH1Ar: body.seoH1Ar !== undefined ? String(body.seoH1Ar || '').trim() : undefined,
