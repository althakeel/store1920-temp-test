...
const RELATED_SELECT =
  'name nameAr slug price AED images category categories inStock stockQuantity imageAspectRatio averageRating ratingCount useProductsPath createdAt';

const FBT_SELECT =
  'name nameAr price images slug hasVariants variants inStock stockQuantity useProductsPath createdAt';
