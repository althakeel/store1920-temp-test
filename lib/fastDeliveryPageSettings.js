export const DEFAULT_FAST_DELIVERY_PAGE = {
  headerTitle: 'Fast Delivery Across the UAE',
  headerTitleEnabled: true,
  headerSubtitle:
    'Get your order delivered quickly with Store1920’s next-day delivery service, available across all seven Emirates.',
