...
async function fetchManualOffersProducts(
  ...
  const productsRaw = await Product.find({
    ...
    .select('_id name nameAr slug price AED images category categories inStock stockQuantity brand brandAr imageAspectRatio useProductsPath cardVideoPreviewEnabled cardVideoPreviewDelaySec fastDelivery freeShippingEligible legacySourceId createdAt')
    .lean();
