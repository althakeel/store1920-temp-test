...
export const PERMISSION_GROUPS = [
    ...
    },
    {
        ...
        componentIds: ['orders', 'todaysPickup', 'ordersByProduct', 'trash', 'customers', 'customerTracking', 'abandonedCheckout', 'shipping', 'paymentSecurity', 'returnRequests', 'balance', 'salesReport'],
    },
    {
        id: 'marketing',
        label: 'Marketing',
