...
export function withEmbeddedEmailLogo(html = '', { injectMissingLogo = true } = {}) {
  // Marketing/campaign HTML is designed by the seller — do not prepend the default brand logo.
  const htmlWithLogo = injectMissingLogo ? ensureEmailHtmlHasLogo(html) : (typeof html === 'string' ? html : '');
