...
- Shipping fees vary by product and location; free shipping only on eligible products or when checkout shows a free-shipping offer
- Standard delivery (estimate): about 2-6 business days depending on location and courier
- Fast delivery available on select products marked for faster shipping
- Delivery timelines at checkout/product pages are estimates, not guarantees
- We deliver across the UAE; weekend timing can vary by area
- Tracking is shared after shipment when available
- Keep address and phone accurate at checkout for successful delivery

**RETURN & REFUND POLICY:**
- Commercial return request window: 7 calendar days after delivery for an eligible item (My Orders, Return Request page, or support)
- Store1920 error (wrong, damaged, defective, incomplete, not as described): Store1920 pays return shipping; not limited by the 7-day change-of-mind window
- Change of mind: unused / unactivated / resalable; customer pays the disclosed return-collection charge
- Remedies: repair, replacement, or refund as required; if replacement stock is unavailable we refund. Change of mind is a refund
- Order value and sale pricing do not remove return rights for defects or other mandatory UAE rights
- Approved refunds are initiated within 5–7 business days after approval to the original payment method (COD: verified UAE bank transfer)
...
A: Submit a Return Request from My Orders or contact support with your order ID and photos/video. Store1920 pays return shipping for wrong, damaged, defective or not-as-described items. Those cases are not limited by the 7-day change-of-mind window. See /return-policy.

Q: Do you charge shipping?
A: Shipping fees vary and are shown at checkout. Free shipping applies only on eligible products or when an offer is shown at checkout — it is not free on every order.
...
A: For a Store1920 error or defect we replace the same item when stock exists; otherwise we refund. Change of mind is a refund — place a new order for a different item. See /return-policy.

Q: How long do refunds take?
A: Approved refunds are initiated within 5–7 business days after approval to the original payment method. Your bank or provider may take extra time to show the credit. COD refunds are by verified UAE bank transfer.

Q: Can I cancel my order?
A: Yes, any time before dispatch via My Orders or support. After dispatch, this return policy applies after delivery.
            ...
            if (apiError.message?.includes('429') || apiError.message?.includes('quota') || apiError.status === 429) {
                ...
                const fallbackResponses = {
                    english: {
                        ...
                        'shipping': "we've got delivery across the UAE! 🚚📦\n\n✅ Shipping:\n  • Fees vary by product/location — shown at checkout\n  • Free shipping only when the product or checkout offer qualifies\n  • Delivery dates on product pages are estimates\n\n⏱️ Typical estimates:\n  • Standard: about 2-6 business days\n  • Faster options on select products\n\n📍 Features:\n  • Tracking after shipment when available\n  • SMS/email updates\n  • Accurate address + phone needed at checkout\n\nsee /shipping-policy for full details.",
                        ...
                        'return': "here's our return policy (aligned with /return-policy):\n\n✅ Request window:\n  • 7 calendar days after delivery for an eligible item\n  • Submit via My Orders, Return Request, or support\n  • Wrong, damaged, defective or not-as-described items are not limited by that 7-day change-of-mind window\n\n💰 Shipping:\n  • Store1920 pays return shipping for wrong/damaged/defective/not-as-described items\n  • Change of mind: unused item; you pay the disclosed collection charge\n\n🔁 Remedies:\n  • Repair, replacement, or refund as required\n  • If replacement stock is unavailable we refund\n  • Change of mind is a refund, then you can place a new order\n\n📦 How to return:\n1. Go to My Orders\n2. Open the delivered order\n3. Submit Return Request\n4. Attach proof if relevant and wait for review\n\nFull details: /return-policy\nneed help with a specific order number?",
                        ...
                        'cancel': "need to cancel? here's how (per /return-policy):\n\n⏰ Cancellation:\n  • You may request cancellation any time before dispatch\n  • After dispatch, cancellation may not be possible and the return policy applies after delivery\n\n📱 How to Cancel:\n1. Go to My Orders\n2. Find your order\n3. Cancel if still available\n4. Or contact support with order ID\n\n💰 Approved prepaid cancellations are refunded to the original payment method.\n\nwhich order do you want to cancel?",
                        'policy': "our policies (website is the source of truth):\n\n↩️ Returns / Refunds / Replacement / Cancellation:\n  • Master policy: /return-policy\n  • 7 calendar days after delivery for eligible change-of-mind returns\n  • Store1920 pays return shipping for wrong/damaged/defective/not-as-described items\n  • Approved refunds initiated 5–7 business days after approval\n  • Cancel any time before dispatch\n\n🚚 Shipping:\n  • /shipping-policy\n  • Fees shown at checkout\n  • Free shipping only when product/offer qualifies\n  • Delivery dates are estimates\n\n🔒 Privacy: /privacy-policy\n📜 Terms: /terms-and-conditions\n\nwhich policy do you want details on?",
