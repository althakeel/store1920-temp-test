...
const OrderSchema = new mongoose.Schema({
  ...
  waslah: {
    ...
    pickupOverdueNotifiedAt: { type: Date, default: null },
  ...
  // Reverse pickup on the original sale (customer → warehouse). Kept separate
  // so the outbound EMX AWB / label on `waslah` is not overwritten.
  waslahReturn: {
  ...
  sourceReturnIndex: { type: Number, default: null },
  sourceReturnRequestId: { type: mongoose.Schema.Types.ObjectId, ref: 'ReturnRequest', default: null, index: true },
  sourceReturnNumber: { type: String, default: null },
